...
const skills = {
    // ── スサノオ（カイト／攻撃・雷） ───────────────────────────
    raimei:        { name: '雷鳴斬',   god: 'スサノオ', mpCost: 6,  power: 18, type: 'damage', target: 'one',        element: 'thunder', desc: '雷を帯びた一閃。敵1体に雷ダメージ' },
    narukami:      { name: '鳴神',     god: 'スサノオ', mpCost: 14, power: 22, type: 'damage', target: 'allEnemies', element: 'thunder', desc: '敵全体に雷ダメージ' },
    amenomurakumo: { name: '天叢雲',   god: 'スサノオ', mpCost: 24, power: 44, type: 'damage', target: 'one',        element: 'thunder', crit: 0.3, desc: '神剣の一撃。高威力・高会心' },

    // ── アマテラス（アカリ／回復・浄化） ──────────────────────
    hikari: { name: '陽の癒し',   god: 'アマテラス', mpCost: 8,  power: 30, type: 'heal',    target: 'oneAlly',  desc: '味方1体のHPを回復' },
    taiyo:  { name: '太陽の恵み', god: 'アマテラス', mpCost: 18, power: 24, type: 'heal',    target: 'allAllies', desc: '味方全体のHPを回復' },
    harae:  { name: '祓い',       god: 'アマテラス', mpCost: 10,            type: 'cleanse', target: 'oneAlly',  desc: '味方1体の弱体・状態異常を解除' },

    // ── ツクヨミ（ヤミ／魔法・妨害） ──────────────────────────
    tsukikage:   { name: '月影',             god: 'ツクヨミ', mpCost: 10, power: 22, type: 'damage', target: 'one', element: 'dark', desc: '敵1体に闇ダメージ' },
